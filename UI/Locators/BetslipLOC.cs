...
namespace UI.Locators
{
    class BetslipLOC
    {
        ...
        public static By ValidationMessage { get; } = By.CssSelector(".betslip-error");
        ...
        public static By Spinner { get; } = By.CssSelector(".betslip__purchase-loading-copy");
        ...
        public static By ButtonAgencyTicket { get; } = By.CssSelector(".betslip-footer .e2e-binary-switcher-second");
